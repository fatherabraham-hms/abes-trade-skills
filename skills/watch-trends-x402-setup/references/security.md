...
| `TELEGRAM_BOT_TOKEN` / `HERMES_TELEGRAM_TOKEN` | `X402_MAX_AMOUNT_ATOMIC`, `X402_DAILY_LIMIT_ATOMIC` |
| | `WATCHTRENDS_CDP_ACCOUNT_NAME`, `WATCHTRENDS_STATE_DIR` |
| | `WATCHTRENDS_NOTIFY_CMD`, `WATCHTRENDS_NOTIFY_TARGET` |
